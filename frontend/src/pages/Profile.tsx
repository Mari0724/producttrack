...
const Profile = () => {
  ...
  const userProfile: UserProfile = {
    type: 'EMPRESARIAL', // Cambia según pruebas: 'INDIVIDUAL', 'EMPRESARIAL', 'EQUIPO'
    username: '',
    name: '',
    email: '',
    phone: '',
    ...
    <div className="px-4 sm:px-0 max-w-4xl mx-auto">
      ...
      <div className="mb-6 border-b border-gray-200 flex gap-8">
        <button
          ...
          className={`py-2 font-semibold ${activeTab === 'perfil' ? 'text-[#667233] border-b-2 border-[#667233]' : 'text-gray-500'
            }`}
        >
        ...
        <button
          ...
          className={`py-2 font-semibold ${activeTab === 'seguridad' ? 'text-[#667233] border-b-2 border-[#667233]' : 'text-gray-500'
            }`}
        >
          Seguridad
        </button>
      ...
      {activeTab === 'seguridad' && (
        <div className="bg-white shadow rounded p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="flex items-center text-[#667233] border border-[#667233] px-4 py-2 rounded hover:bg-[#f6f6e3]">
